...
// This annotation links the listener class defined below to this test
...
public class Testng {
    ...
    public Object[][] getValues() {
        return new Object[][] {
            ...
            {"problem_user", "secret_sauce", "success"},    // Valid
            {"standard_user", "wrong_pass", "error"},        // Invalid Pass
    ...
    // --- BONUS: SCREENSHOT LISTENER (Inner Class) ---
