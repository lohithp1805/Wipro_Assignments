...
public class AmazonAutomation {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.xpath("//*[@id=\"ap_email_login\"]")).sendKeys("9392401343");
        Thread.sleep(2000);
        ...
        driver.findElement(By.xpath("//*[@id=\"ap_password\"]")).sendKeys("Lohi@2004");
        Thread.sleep(2000);
      ...
      //  *********************
        driver.findElement(By.xpath("//*[@id=\"pp-IMY8eP-122\"]"));
